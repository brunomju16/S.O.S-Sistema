...
class Relatorios_model extends CI_Model
{
    ...
    public function clientesCustom2($dataInicial = null, $dataFinal = null)
    {
    ...
    public function osRapid()
    {
        ...
        $this->db->select('os.*,clientes.nomeCliente, total_servicos.total_servico');
        $this->db->from('os');
    ...
    public function osCustom($dataInicial = null, $dataFinal = null, $cliente = null, $responsavel = null, $status = null)
    {
        ...
        $query = "SELECT os.*,clientes.nomeCliente, total_servicos.total_servico FROM os
