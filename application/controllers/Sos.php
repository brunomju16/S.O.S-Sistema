...
class Sos extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ordens'] = $this->sos_model->getOsAbertas();
        $this->data['ordens1'] = $this->sos_model->getOsAguardandoPecas();
        $this->data['os'] = $this->sos_model->getOsEstatisticas();
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'sos/painel';
    ...
    public function minhaConta()
    {
        ...
        $this->data['usuario'] = $this->sos_model->getById($this->session->userdata('id'));
        $this->data['view'] = 'sos/minhaConta';
        $this->load->view('tema/topo', $this->data);
    }
    ...
    public function alterarSenha()
    {
        ...
        $current_user = $this->sos_model->getById($this->session->userdata('id'));

        if (!$current_user) {
            $this->session->set_flashdata('error', 'Ocorreu um erro ao pesquisar usuário!');
            redirect(base_url() . 'index.php/sos/minhaConta');
        }
        ...
        $result = $this->sos_model->alterarSenha($senha);
    ...
    public function pesquisar()
    {
        ...
        $data['results'] = $this->sos_model->pesquisar($termo);
        $this->data['servicos'] = $data['results']['servicos'];
        $this->data['os'] = $data['results']['os'];
        $this->data['clientes'] = $data['results']['clientes'];
        $this->data['view'] = 'sos/pesquisa';
        $this->load->view('tema/topo', $this->data);
    }
    ...
    public function verificarLogin()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $user = $this->Sos_model->check_credentials($email);
    ...
    public function emitente()
    {
        ...
        $data['dados'] = $this->sos_model->getEmitente();
        $data['view'] = 'sos/emitente';
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/sos/emitente');
        } else {
            ...
            $retorno = $this->sos_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo);
            if ($retorno) {
    ...
    public function editarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->sos_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email);
            if ($retorno) {
    ...
    public function editarLogo()
    {
        ...
        $retorno = $this->sos_model->editLogo($id, $logo);
        if ($retorno) {
