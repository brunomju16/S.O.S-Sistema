...
class Servicos extends CI_Controller
{
    ...
    public function gerenciar()
    {
        ...
        $this->data['results'] = $this->servicos_model->getServicos('servicos', 'idServicos,nome,descricao,preco', $where_array, $config['per_page'], $this->uri->segment(3));
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('servicos') == false) {
            ...
            $data = array(
                ...
                'preco' => $preco,
                'situacaoser' => set_value('situacaoser'),
            );
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run('servicos') == false) {
            ...
            $data = array(
                ...
                'preco' => $preco,
                'situacaoser' => $this->input->post('situacaoser'),
            );
    ...
    public function excluir()
    {
        ...
        $os = $this->db->get('servicos_os')->result();

        if ($os != null) {
            $this->session->set_flashdata('error', 'Este serviço já está vinculada a uma Ordem de Serviço. Impossivel excluir!');
        
        }else {
            $this->servicos_model->delete('servicos', 'idServicos', $id);
            $this->session->set_flashdata('success', 'Serviço excluido com sucessso!');
        }
