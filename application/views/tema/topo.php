    ...
    <ul class="nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a title="Meu Perfil" href="<?php echo site_url(); ?>/sos/minhaConta"><i class="fas fa-user"></i> <span class="text">Meu Perfil</span></a></li>
          <li class=""><a title="" href="<?php echo site_url(); ?>/mine"><i class="fas fa-eye"></i> <span class="text">Área do Cliente</span></a></li>
          <li class="divider"></li>
          <li class=""><a title="Sair do Sistema" href="<?php echo site_url(); ?>/sos/sair"><i class="fas fa-sign-out-alt"></i> <span class="text">Sair do Sistema</span></a></li>
        </ul>
      </li>
  ...
  <div id="sidebar"> <a href="#" class="visible-phone"><i class="fas fa-list"></i> Menu</a>
    <ul>
      <li class="<?php if (isset($menuPainel)) {
                    echo 'active';
                  }; ?>"><a href="<?php echo base_url() ?>index.php/sos"><i class="fas fa-home"></i> <span>Painel</span></a></li>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOs')) { ?>
        <li class="<?php if (isset($menuOs)) {
                        echo 'active';
                      }; ?>"><a href="<?php echo base_url() ?>index.php/os"><i class="fas fa-diagnoses"></i> <span>Ordem de Serviço</span></a></li>
      <?php
      } ?>
        ...
        <li class="submenu <?php if (isset($menuConfiguracoes)) {
          ...
          <ul>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'cEmitente')) { ?>
              <li><a href="<?php echo site_url('sos/emitente') ?>">Emitente</a></li>
            <?php } ?>
            ...
            <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'cBackup')) { ?>
              <li><a href="<?php echo site_url('sos/backup') ?>">Backup</a></li>
            <?php } ?>
      ...
      <li> 
        <a class="text-white" href="<?php echo site_url('sos/sair'); ?>"><i class="fas fa-sign-out-alt"></i> <span>Sair</span></a>
      </li>
  ...
  <div class="conteudotopo">
    <div id="content">
      <div id="content-header">
        <div id="breadcrumb"> <a href="<?php echo base_url() ?>" title="Dashboard" class="tip-bottom"><i class="fas fa-home"></i> Painel</a>
