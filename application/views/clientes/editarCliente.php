    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form">
                <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <select name="situacaocli" id="situacaocli">
                                <?php if ($result->situacaocli == 0) {
                                    $ativo = 'selected';
                                    $inativo = '';
                                } else {
                                    $ativo = '';
                                ...
                                <option value="0" <?php echo $ativo; ?>>Ativo</option>
                                <option value="1" <?php echo $inativo; ?>>Inativo</option>
                            </select>
                        </div>
                    </div>
                </div>
