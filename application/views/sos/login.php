...
<body>
    <div id="loginbox">
        <form class="form-vertical" id="formLogin" method="post" action="<?php echo base_url() ?>index.php/sos/verificarLogin">
        ...
        $(document).ready(function() {
            ...
            $("#formLogin").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>index.php/sos/verificarLogin?ajax=true",
                        data: dados,
                        dataType: 'json',
                        success: function(data) {
                            if (data.result == true) {
                                window.location.href = "<?php echo base_url(); ?>index.php/sos";
                            } else {
    ...
    <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h4 id="myModalLabel">SOS Sistemas</h4>
        </div>
