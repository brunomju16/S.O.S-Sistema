    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url() ?>index.php/relatorios/osRapid"><i class="fas fa-diagnoses"></i> <small>Todas as Ordens de Serviço</small></a></li>
