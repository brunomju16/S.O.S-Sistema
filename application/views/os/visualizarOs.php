                        ...
                        <table class="table table-condensed" style="">
                            <tbody>
                                <?php if ($emitente == null) { ?>
                                    ...
                                    <tr>
                                        <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/sos/emitente">Configurar</a>
                                            <<<</td> </tr> <?php } else { ?> <tr>
